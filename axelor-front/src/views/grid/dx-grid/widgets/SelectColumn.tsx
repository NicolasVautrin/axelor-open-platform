...
/**
 * Composant pour la cellule de sélection en mode affichage (checkbox)
...
/**
 * Composant pour la cellule de sélection en mode édition (icône undo)
 */
 ...
 * - cellRender : mode affichage (checkbox)
 * - editCellRender : mode édition (icône undo)
 *
